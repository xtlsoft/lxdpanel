...
<div class="layui-layout layui-layout-admin"> <!-- 添加skin-1类可手动修改主题为纯白，添加skin-2类可手动修改主题为蓝白 -->
    ...
    <div class="layui-header my-header">
        <a href="javascript:;">
            ...
            <div class="my-header-logo">{{ $GLOBALS['_C']['SiteName'] }}</div>
        </a>
        ...
        <ul class="layui-nav my-header-user-nav" lay-filter="side-top-right">
            ...
            <li class="layui-nav-item">
                <a class="name" href="javascript:;"><img src="/static/default/site/image/code.png" alt="logo"> Admin </a>
                <dl class="layui-nav-child">
                    ...
                    <dd><a href="/login/logout.do"><i class="layui-icon">&#x1006;</i>退出</a></dd>
                </dl>
            </li>
        </ul>
...
<script type="text/javascript" src="/static/default/site/js/index.js"></script>
...
layui.use(['layer','vip_nav'], function () {
    ...
    // vipNav.top_left('/static/default/site/json/nav_top_left.json','side-top-left',false);
    // 主体菜单生成 [请求地址,过滤ID,是否展开,携带参数]
    // vipNav.main('/static/default/site/json/nav_main.json','side-main',true);
